...
local user_host='%{$fg[red]%}%n%{$fg_bold[yellow]%}@%{$fg_bold[cyan]%}%m%{$reset_color%}'
...
# Prompt layout
PROMPT="%{$fg[red]%}┌──${error_symbol}[${user_host}%{$fg[red]%}]─[${current_dir}%{$fg[red]%}]─[${date_time}%{$fg[red]%}]%{$reset_color%}${rvm_ruby}${git_branch}
